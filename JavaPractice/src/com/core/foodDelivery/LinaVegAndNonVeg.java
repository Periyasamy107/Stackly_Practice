...
public class LinaVegAndNonVeg extends FoodBookingStatus implements FoodBooking, Foods, Distance {

    public static final double tax = 0.30;

    public void bookFood() {
        System.out.println("\n------------------------------------------------------------");
        System.out.println("Lina veg and non-veg food booking...");
    }
    ...
    @Override
    public void status() {
        System.out.println("\nLina Veg and Non-Veg Food Delivered successfully.");
    }
