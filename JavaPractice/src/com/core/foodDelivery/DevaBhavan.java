...
public class DevaBhavan extends FoodBookingStatus implements FoodBooking, Foods, Distance {

    public static final double tax = 0.20;

    public void bookFood() {
        System.out.println("\n------------------------------------------------------------");
        System.out.println("Deva bhavan food booking...");
    }
    ...
    @Override
    public void status() {
        System.out.println("\nDeva Bhavan Food Delivered successfully.");
    }
