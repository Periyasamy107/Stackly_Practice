...
public class AutoCab extends CabBookingStatus implements CabBooking {

    public static final int oneKM = 55;
    public static final int onePointFiveKM = 85;
    ...
    public void bookRide(){
        System.out.println("Auto Cab booking...");
    }
    ...
    public void bookingStatus() {
        System.out.println("AUTO CAB BOOKED SUCCESS.");
    }
